...
// Get a list of topics from a specific space that belong to the "Ideas" channel.
$space_id = 1;
$channel = "ideas";
// Change "ideas" to "problems", "knowledgebase", "all_topics", etc
// to retrieve a list of topics from a different channel.
$url = "https://$yourdomain.$server/api/v1/spaces/$space_id/$channel";
